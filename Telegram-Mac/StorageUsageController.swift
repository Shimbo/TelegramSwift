...
class StorageUsageController: TableViewController {
    ...
    override func viewDidLoad() {
        ...
        statsPromise.set(.single(nil) |> then(collectCacheUsageStats(account: context.account, additionalCachePaths: [], logFilesPath: "~/Library/Group Containers/WDEGJM2L33.com.circlescollective.circlesfortelegram/logs".nsstring.expandingTildeInPath) |> map { Optional($0) }))
